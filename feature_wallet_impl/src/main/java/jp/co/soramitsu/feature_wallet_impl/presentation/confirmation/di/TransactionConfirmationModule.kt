...
class TransactionConfirmationModule {
    ...
    fun provideViewModel(
        ...
        return TransactionConfirmationViewModel(
            walletInteractor, ethereumInteractor, router, progress, resourceManager,
            numbersFormatter, textFormatter, partialAmount, amount, minerFee, transactionFee,
            description, peerFullName, peerId, transferType, retrySoranetHash, clipboardManager
        )
    }
