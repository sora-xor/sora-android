...
class ActivityGsonConverterTest {
    ...
    @Before fun setup() {
        ...
        given(resourceManager.getString(R.string.activity_val_between_users_transferred_type_template)).willReturn("XOR Received")
        ...
        given(resourceManager.getString(R.string.activity_project_funded_description_template_val)).willReturn("You will receive information about XOR reward soon")
        ...
        given(resourceManager.getString(R.string.activity_val_reward_credited_from_project_type_template)).willReturn("XOR Reward for voting")
