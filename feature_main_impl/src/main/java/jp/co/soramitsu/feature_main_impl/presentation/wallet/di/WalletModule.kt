...
class WalletModule {
    ...
    fun provideViewModel(walletInteractor: WalletInteractor, router: MainRouter, pushHandler: PushHandler): ViewModel {
        return WalletViewModel(walletInteractor, router, pushHandler)
    }
