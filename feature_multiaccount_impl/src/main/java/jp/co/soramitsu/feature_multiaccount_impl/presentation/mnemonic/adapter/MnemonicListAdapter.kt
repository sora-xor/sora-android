...
package jp.co.soramitsu.feature_multiaccount_impl.presentation.mnemonic.adapter
...
import jp.co.soramitsu.feature_multiaccount_impl.presentation.mnemonic.model.MnemonicWord
...
class MnemonicListAdapter : ListAdapter<MnemonicWord, MnemonicListItemViewHolder>(DiffCallback) {
    ...
    override fun onCreateViewHolder(
        viewGroup: ViewGroup,
        viewType: Int
    ): MnemonicListItemViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.item_mnemonic_word, viewGroup, false)
