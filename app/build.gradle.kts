...
// soralution 137 3.8.3.1 2024.02.21
// sora dae 113 3.8.3.1 2024.02.21
...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 34
        versionCode = System.getenv("CI_BUILD_ID")?.toInt() ?: 113
        versionName = "3.8.3.1"
...
play {
    ...
    releaseName = "3.8.3.1 - SORA Card Improvements"
